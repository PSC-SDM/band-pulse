        ...
        <div className="flex min-h-screen items-center justify-center bg-night">
            <div className="w-full max-w-md rounded-lg bg-prussian p-8 shadow-2xl border border-alabaster/10">
                ...
                <form onSubmit={handleRegister} className="space-y-4 mb-6">
                    <div>
                        <label htmlFor="name" className="block text-sm font-body text-alabaster/80 mb-1">
                            Name
                        </label>
                        <input
                            id="name"
                    ...
                    <div>
                        <label htmlFor="confirmPassword" className="block text-sm font-body text-alabaster/80 mb-1">
                            Confirm Password
                        </label>
                        <input
                            id="confirmPassword"
